...
| 文档 | 阶段 | 状态 |
| --- | --- | --- |
| [设定与故事背景](systems/00-setting-and-lore.md) | 全程 | 已拍板 v1.1（断航 / 开拓局 / 威胁—解法 / 订单） |
...
`Galactic Frontier / 群星边境`：断航三百年后，你作为群星开拓局新舰长，在熵雾撕裂的第七前沿**看清每一区的威胁、造出对的装备、在有限编制下推进前哨**——战斗提问、生产作答、编制取舍。
