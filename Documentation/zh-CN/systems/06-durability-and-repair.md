...
> 实现阶段：开发计划 P3.4（见 `../11-mvp-development-plan.md`） — **完成**  
> 更新日期：2026-08-10
...
- [x] 装备具有当前/最大耐久；品质影响最大耐久（表驱动可加深）
- [x] 主线与挂机战斗按表损耗；采集高风险额外损耗
- [x] 归零不销毁；属性加成视为 0
- [x] 维修消耗可预览、无随机失败（MVP 修满）
- [x] 自动维修可开关，默认阈值 30%
- [x] 维修不占用生产卡组
- [x] 关键破损且无料时挂机 `PausedBlock`
- [x] EditMode：损耗公式、修满耗料、归零不删、自动修材料不足
