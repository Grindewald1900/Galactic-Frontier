...
namespace Assets.Resources.Scripts.Achievement
{
    public class AchievementController : MonoBehaviour
    {
        ...
        public Vector2 spacing = new(10f, 10f); // 横向和纵向间隔
        public List<BadgeEntity> badges = new(); // 所有成就的列表
        ...
        void Start()
        {
            ...
            {
                GameObject badgeGO = Instantiate(badgePrefab, gridContainer);
                Badge badge = badgeGO.GetComponent<Badge>();
