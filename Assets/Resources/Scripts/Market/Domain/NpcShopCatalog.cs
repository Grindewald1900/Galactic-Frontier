    ...
    public static class NpcShopCatalog
    {
        ...
        private static NpcShopDef BuildStarportShop()
        {
            return new NpcShopDef
            {
                ...
                {
                    Offer("offer_scrap", "mat_scrap", 2, 4, true, true, 0, null),
                    ...
                    Offer("offer_fungal", "mat_fungal", 2, 9, true, true, 0,
                        Unlock("sec01_mining_spur", 1)),
                    Offer("offer_alloy", "mat_alloy_plate", 2, 22, true, true, 20,
                        Unlock("sec01_outer_belt", 2)),
                    Offer("offer_energy", "mat_energy_cell", 2, 28, true, true, 20,
                        Unlock("sec01_mining_spur", 2)),
                    Offer("offer_biofiber", "mat_biofiber", 2, 18, true, true, 20,
                        Unlock("sec01_mining_spur", 2)),
                    Offer("offer_repair_kit", EconomyConstants.RepairKitDefId, 2, 35, true, true, 10,
                        Unlock("", 1)),
                    Offer("offer_repair_parts", "mat_repair_parts", 2, 12, true, true, 0, null),
